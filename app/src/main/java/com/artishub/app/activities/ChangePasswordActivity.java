...
import com.artishub.app.databinding.ActivityChangePasswordBinding;
...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppUtilis.setGradientTextColor(this, binding.txtForgotPasswordTitle);

        binding.btnSubmit.setOnClickListener(view -> {
            if (checkData()) {
                oldPassword = binding.edtOldPassword.getText().toString();
                newPassword = binding.edtConfirmPassword.getText().toString();
    ...
    private boolean checkData() {
        if (!AppValidator.isValidPassword(this, binding.edtOldPassword, MsgConstant.PASSWORD_ERROR_VOID)) {
            return false;
        } else if (!AppValidator.isValidPassword(this, binding.edtPassword, MsgConstant.PASSWORD_ERROR_VOID)) {
            return false;
        } else if (!AppValidator.isValidPassword(this, binding.edtConfirmPassword, MsgConstant.CONFIRM_PASSWORD_ERROR_VOID)) {
            return false;
    ...
    private void callForgotPasswordApi() {
        ...
        params.put("method", "change_password");
        ...
        apiRequest.setUrl(ServerConstants.BASE_URL)
                ...
                .setParams(params)
                .setTag("change Password password")
