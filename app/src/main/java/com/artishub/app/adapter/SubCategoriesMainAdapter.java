 ...
 */
public class SubCategoriesMainAdapter extends RecyclerView.Adapter<SubCategoriesMainAdapter.ViewHolder> {

    ArrayList<SubCategoriesModel.ProductBySubcategoryBean> productBySubcategoryBeans=new ArrayList<>();
    private Context context;
    private LayoutInflater layoutInflater;
    private String categories;

    public SubCategoriesMainAdapter(ArrayList<SubCategoriesModel.ProductBySubcategoryBean> productBySubcategoryBeans, Context context,String categories) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SubCategoriesMainAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.txtCategoriesName.setText(categories);
